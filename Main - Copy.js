...
window.onload = function () {
    ...
    var baseMap = L.tileLayer('https://api.mapbox.com/styles/v2/sinba/ciperkjzk001jb6mdcb41o922/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic2luYmEiLCJhIjoiY2loMWF6czQxMHdwcnZvbTNvMjVhaWV0MyJ9.zu-djzdfyr3C_Uj2F7noqg', {
        maxZoom: 18,
        minZoom: 9,
    ...
    stationLayer = L.geoJSON(AVGCOMB, {
        onEachFeature: myFunctionHolder.addPopups,
        pointToLayer: myFunctionHolder.pointToCircle
    });

    /*(station2Layer = L.geoJSON(AVGCOMB, {
        onEachFeature: myFunctionHolder.addPopups,
        pointToLayer: myFunctionHolder.pointToCircle
    });*/ 
